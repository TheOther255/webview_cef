set(cef_version "118.6.9%2Bg7e73645%2Bchromium-118.0.5993.119")
...
function(build_cef filepath)
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
        ...
        # unfortunately on linux we have to recover libcef.so from the linux/cef_release folder, cause
        # the delivered library is too big for a release
        file(INSTALL "${filepath}/../../linux/cef_release/" DESTINATION "${filepath}/Release/")
        # debug
...
function(prepare_and_build filepath)
    ...
    if(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
        ...
        file(REMOVE_RECURSE ${CMAKE_CURRENT_SOURCE_DIR}/cef.tar.bz2)
        build_cef(${filepath}/${arch})
        execute_process(COMMAND ./build_cef_macos.sh OUTPUT out WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}/..")
        message(STATUS ${out})
    else()
        download_file(${cef_path_${arch}} ${CMAKE_CURRENT_SOURCE_DIR}/cef.tar.bz2)
